...
class TahunArsipDokumenController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        $request->validate(
            [
                'tahun' => ['required','max:4', Rule::Unique('tahun_arsip_dokumen')->whereNull('deleted_at')]
            ],
            [
        ...
        TahunArsipDokumen::create($request->all());
    ...
    {
        TahunArsipDokumen::findOrFail($id)->delete();
