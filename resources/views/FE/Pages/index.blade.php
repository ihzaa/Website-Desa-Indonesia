...
<head>
  ...
  <link href="{{asset('FE/vendor/venobox/venobox.css')}}" rel="stylesheet">
  <link href="{{asset('FE/vendor/owl.carousel/FE/owl.carousel.min.css')}}" rel="stylesheet">
...
<body>
  ...
  <script src="{{asset('FE/vendor/venobox/venobox.min.js')}}"></script>
