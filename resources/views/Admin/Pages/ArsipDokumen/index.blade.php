...
@section('page_title','Arsip Dokumen Desa')
...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <h3 class="card-title m-2">Daftar arsip dokumen desa berdasarkan tahun</h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;Hapus</button>
                        &nbsp;
                        <a href="{{route('admin_arsip_dokumen_kelola_index', $data->id)}}" class="btn btn btn-warning"><i
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formCreate" action="{{route('admin_arsip_dokumen_store')}}" method="post">
                @csrf
...
<script>
    $(function () {
        ...
        $(".deleteModal").click(function (e) {
            let id = $(this).attr("id")
            $('#formDelete').attr('action', '/4dm1n/arsip-dokumen/' + id)
        });
