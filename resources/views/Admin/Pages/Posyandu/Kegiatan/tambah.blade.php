        ...
        <div class="col-md-12">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        Halaman Editor Kegiatan
                    </h3>
                </div>
                <!-- /.card-header -->
                <form action="{{route('kegiatan_posyandu_save',['id'=>$posyandu->id])}}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    <div class="card-body pad">
                        <div class="form-group">
                            <label for="judul">Judul Kegiatan</label>
                            <input id="judul" type="text" name="judul_kegiatan" class="form-control" placeholder="Masukkan judul kegiatan posyandu" required>
                        </div>
                        <div class="form-group">
                            <label>Thumbnail Kegiatan</label>
                            <input type="file" accept="image/jpeg,image/png" name="thumbnail" class="form-control" required>
                            <ul>
                                <li>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="konten" name="kegiatan" class="textarea mb-3" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
                        </div>
                        <div class="form-group">
